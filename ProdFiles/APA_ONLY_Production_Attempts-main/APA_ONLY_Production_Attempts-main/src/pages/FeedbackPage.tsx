        ...
        {metrics && metrics.apaReorderings > 0 && (
          <div className="bg-gradient-to-br from-green-50 via-emerald-100 to-teal-50 rounded-lg shadow-lg border-2 border-green-300 p-6 mb-8">
            ...
            <p className="text-sm text-green-800 font-medium mb-6 leading-relaxed bg-white/60 p-3 rounded-lg">
              The APA (Adaptive Preference Alignment) feature allowed you to compare your chosen options with your calculated aligned values and reprioritize your values based on new insights. The goal is to help you understand options from different perspectives and align future choices with your reordered values.
            </p>
