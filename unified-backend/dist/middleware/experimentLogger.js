export function experimentLogger(req, res, next) {
...
export function getExperimentFromRequest(req) {
    return req.headers["x-experiment-name"] || "UNKNOWN";
}
//# sourceMappingURL=experimentLogger.js.map